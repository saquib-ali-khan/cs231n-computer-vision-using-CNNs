...
class TwoLayerNet(object):
  ...
  def loss(self, X, y=None):
    ...
    #print "input to second layer:",cache_scores[0].shape,"dx1 shape",dx1.shape
    dW2 += self.reg * W2

    # Backprop into first layer
    dx, dW1, db1 = affine_relu_backward(dx1, cache_hidden_layer)
    #print "hello"
    #print "input to hidden_layer_shape:",cache_hidden_layer[0][0].shape,"dx1 shape",dx1.shape,"dx0 shape",dx.shape
    dW1 += self.reg * W1
